...
import { useGetCategoriesQuery } from 'store/apis/admin/job-categories'
import { useGetTypesQuery } from 'store/apis/admin/job-types'
import { useCreateJobMutation } from 'store/apis/admin/job'
